...
_DATA_DIR="/mnt/data1/t-rsun/datasets"
# _SAVE_DIR="/home/t-rsun/code/Adaptive-Multimodal-Agent/results/mind2web/ShowUI_2B_ZS"
# _SAVE_DIR="/home/t-rsun/code/Adaptive-Multimodal-Agent/results/mind2web/Long_2B_ZS"
...
# _SAVE_DIR="/home/t-rsun/code/Adaptive-Multimodal-Agent/results/mind2web/QwenVL_3B_SFT"
_SAVE_DIR="/mnt/data1/t-rsun/results/mind2web/Long_Context_AMD"
# _SAVE_DIR="/home/t-rsun/code/Adaptive-Multimodal-Agent/results/mind2web/Long_2B_SFT"

# Fine-tune ShowUI
# deepspeed --include localhost:0 --master_port 1224 train.py \
# deepspeed --hostfile=./hostfile --master_port 1224 train.py \
#   --wandb_key=$WANDB_KEY \
...
# python -m torch.distributed.run --nproc_per_node 4 --master_port 9950 train.py \
#   --wandb_key=$WANDB_KEY \
...
# --random_sample \
# python -m torch.distributed.run --nproc_per_node 1 --master_port 9950 train.py \
#   --wandb_key=$WANDB_KEY \
#   --model_id="Qwen/Qwen2.5-VL-3B-Instruct" \
#   --version='Qwen/Qwen2.5-VL-3B-Instruct' \
#   --dataset_dir=$_DATA_DIR \
...
# deepspeed --include localhost:0,1,2,3 --master_port 5678 train.py \
# python -m torch.distributed.run --nproc_per_node 4 --nnodes 1 --node_rank 0 --master_port 5678  --master_addr node-0 train.py \
# python -m torch.distributed.run --nproc_per_node 1 --master_port 9950 train.py \
#   --wandb_key=$WANDB_KEY \
#   --model_id="showlab/ShowUI-2B" \
#   --version='showlab/ShowUI-2B' \
