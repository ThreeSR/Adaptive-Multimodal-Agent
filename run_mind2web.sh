...
# _SAVE_DIR="/home/ruis/code/Adaptive-Multimodal-Agent/results/mind2web/ShowUI_2B_ZS"
_SAVE_DIR="/local3/ruis/Adaptive-Multimodal-Agent/results/mind2web/ShowUI_2B_SFT" # nlp-13 -> nlp-14

# Fine-tune ShowUI
deepspeed --include localhost:2,3,4,5,6,7 --master_port 1224 train.py \
  --wandb_key=$WANDB_KEY \
...
# deepspeed --include localhost:1,2 --master_port 5678 train.py \
#   --wandb_key=$WANDB_KEY \
#   --model_id="showlab/ShowUI-2B" \
#   --version='showlab/ShowUI-2B' \
#   --dataset_dir=$_DATA_DIR \
